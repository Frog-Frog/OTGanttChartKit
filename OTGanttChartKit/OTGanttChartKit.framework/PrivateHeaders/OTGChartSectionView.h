...
@class OTGChartSectionView,OTGChartProcessView,OTGChartPointView;

@protocol OTGChartSectionViewDelegate <NSObject>
...
@interface OTGChartSectionView : UITableViewHeaderFooterView

@property(nonatomic,weak) id<OTGChartSectionViewDelegate> delegate;
