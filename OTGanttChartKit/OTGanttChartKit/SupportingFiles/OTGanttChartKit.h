...
FOUNDATION_EXPORT double OTGanttChartKitVersionNumber;

//! Project version string for OTGanttChartKit.
FOUNDATION_EXPORT const unsigned char OTGanttChartKitVersionString[];
